...
import fragmentShader from "./shaders/hexBlurFarY.frag";
...
export class HexBlurFarYMaterial extends RawShaderMaterial {
	...
	constructor(cocBuffer: Texture, vertical: Texture, diagonal: Texture) {

		super({
			name: "HexBlurFarYMaterial",
			uniforms: {
				vertical: new Uniform(vertical),
				diagonal: new Uniform(diagonal),
